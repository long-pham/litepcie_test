...
class BaseSoC(SoCMini):
    def __init__(self, variant="cle-101", sys_clk_freq=100e6,
...
def main():
    ...
    parser = LiteXArgumentParser(platform=sqrl_acorn.Platform,
                                 description="LiteX SoC on Acorn CLE-101/215(+).")
    parser.add_target_argument("--flash", action="store_true", help="Flash bitstream.")
    parser.add_target_argument("--variant", default="cle-101",
    ...
    pcieopts.add_argument("--with-sata", action="store_true",
...
def main2():
    ...
    argdict2 = {'bus_standard': 'wishbone', 'bus_data_width': 32, 'bus_address_width': 32,
                ...
                'with_timer': True, 'timer_uptime': False, 'with_ctrl': True,
                'with_jtagbone': False, 'jtagbone_chain': 1, 'with_uartbone': False,
                'with_watchdog': False, 'watchdog_width': 32, 'l2_size': 8192}
